...
void Test_methods() {
    ...
    // auto child_1_1 = std::make_shared<Tree_Node>(std::make_shared<Complex_element>(3.4, 2.5), 5);
    // auto child_1_2 = std::make_shared<Tree_Node>(std::make_shared<String_element>("Hi!"), 6);
    // auto child_1_3 = std::make_shared<Tree_Node>(std::make_shared<Real_element>(2.5), 7);
    ...
    // assert(leaf_1->get_child(0) == child_1_1);

    // leaf_2->add_child(child_1_2, *tree);
    // assert(leaf_2->get_child(0) == child_1_2);

    // leaf_3->add_child(child_1_3, *tree);
    // assert(leaf_3->get_child(0) == child_1_3);
    ...
    // auto child_2_1 = std::make_shared<Tree_Node>(std::make_shared<Complex_element>(1.0, 3.14), 8);
    // auto child_2_2 = std::make_shared<Tree_Node>(std::make_shared<String_element>("My name is Nikolay!"), 9);
    // auto child_2_3 = std::make_shared<Tree_Node>(std::make_shared<Complex_element>(1.1, 4.5), 10);
    // auto child_2_4 = std::make_shared<Tree_Node>(std::make_shared<Complex_element>(0.3, 4.9), 11);
    // auto child_2_5 = std::make_shared<Tree_Node>(std::make_shared<String_element>("Bye!"), 12);

    // child_1_1->add_child(child_2_1, *tree);
    // child_1_1->add_child(child_2_2, *tree);
    // child_1_1->add_child(child_2_3, *tree);
    // child_1_1->add_child(child_2_4, *tree);

    
    // // tree->Print_Tree();

    // try {
    //     child_1_1->add_child(child_2_5, *tree);
    // }
    // catch(const TREE_EXCEPTION& err) {
    //     std::cerr << err.what() << std::endl;
    // }

    // leaf_1->remove_child(child_1_1, *tree);
    ...
    // auto preorder_2 = tree->Preorder_Traversal();
    // std::cout << "Preorder Traversal (root -> left -> right): ";
    // while (!preorder_2.empty()) {
    //     std::cout << preorder_2.top() << " ";
    //     preorder_2.pop();
    // }
    // std::cout << std::endl;
    ...
    // auto Post_left_2 = tree->PostOrder_left_Traversal();
    // std::cout << "PostOrder left Traversal (left -> right -> root): ";
    // while (!Post_left_2.empty()) {
    //     std::cout << Post_left_2.top() << " ";
    //     Post_left_2.pop();
    // }
    // std::cout << std::endl;
    ...
    // auto Post_right_2 = tree->PostOrder_right_Traversal();
    // std::cout << "PostOrder right Traversal (right -> left -> root): ";
    // while (!Post_right_2.empty()) {
    //     std::cout << Post_right_2.top() << " ";
    //     Post_right_2.pop();
    // }
    // std::cout << std::endl;
    ...
    // auto level_BFS_traversal_2 = tree->Level_BFS_Traverse();
    // std::cout << "Level_BFS Traverse: ";
    // while (!level_BFS_traversal_2.empty()) {
    //     std::cout << level_BFS_traversal_2.front() << " ";
    //     level_BFS_traversal_2.pop();
    // }
    // std::cout << std::endl;
}
...
void Tests_for_Tree() {
    Test_constructors();
    Test_methods();
    std::cout << "Tests for Tree passed!" << std::endl;
